# Todo and Hello World Rest APIs Connecting to H2 In memory database running on port 80
...
- http://localhost:80/hello-world-bean

```json
{"message":"Hello World - Changed"}
```

- http://localhost:80/hello-world/path-variable/in28minutes
